...
<SwConfiguration CpuAddress="" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  <TaskClass Name="Cyclic#1">
    <Task Name="DistConvey" Source="Source.Distribution.Modules.DistConveyor.DistConveyor.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  ...
  <TaskClass Name="Cyclic#4">
    <Task Name="DistAlarmC" Source="Source.Distribution.Alarms.DistAlarmCtrl.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
