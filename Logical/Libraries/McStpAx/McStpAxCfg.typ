TYPE
	...
	McSAELOEExtRefPEnum :
		...
		mcSAELOEERP_IO_CH_DINT := 3, (*I/O channel DINT - Reference pulse is used with I/O channel*)
		mcSAELOEERP_VAR_DINT := 4 (*Variable DINT - Reference pulse is used with variable*)
		);
	...
	END_STRUCT;
	McSAELOEExtRefPIOChDINTPosType : STRUCT (*Position of the reference pulse*)
		ChannelMapping : STRING[250]; (*Input source for the reference pulse position*)
	END_STRUCT;
	McSAELOEExtRefPIOChDINTCntType : STRUCT (*Count of the reference pulse*)
		ChannelMapping : STRING[250]; (*Input source for the reference pulse count*)
	END_STRUCT;
	McSAELOEExtRefPIOChDINTType : STRUCT (*Type mcSAELOEERP_IO_CH_DINT settings*)
		Position : McSAELOEExtRefPIOChDINTPosType; (*Position of the reference pulse*)
		Count : McSAELOEExtRefPIOChDINTCntType; (*Count of the reference pulse*)
	END_STRUCT;
	McSAELOEExtRefPVarDINTPosType : STRUCT (*Position of the reference pulse*)
		PVMapping : STRING[250]; (*Input source for the reference pulse position*)
	END_STRUCT;
	McSAELOEExtRefPVarDINTCntType : STRUCT (*Count of the reference pulse*)
		PVMapping : STRING[250]; (*Input source for the reference pulse count*)
	END_STRUCT;
	McSAELOEExtRefPVarDINTType : STRUCT (*Type mcSAELOEERP_VAR_DINT settings*)
		Position : McSAELOEExtRefPVarDINTPosType; (*Position of the reference pulse*)
		Count : McSAELOEExtRefPVarDINTCntType; (*Count of the reference pulse*)
	END_STRUCT;
	McSAELOEExtRefPType : STRUCT (*Usage and settings for the evaluation of the reference pulse of the encoder*)
		...
		IOChannelDINT : McSAELOEExtRefPIOChDINTType; (*Type mcSAELOEERP_IO_CH_DINT settings*)
		VariableDINT : McSAELOEExtRefPVarDINTType; (*Type mcSAELOEERP_VAR_DINT settings*)
	END_STRUCT;
	...
	McSAELOEPosEncExtType : STRUCT (*Type mcSAELOEPE_EXT settings*)
		...
		ReferencePulse : McSAELOEExtRefPType; (*Usage and settings for the evaluation of the reference pulse of the encoder*)
	...
	McSAMELStallDetectCfgUseReacEnum :
		...
		mcSAMELSDCUR_NONE := 2 (*None - No reaction is triggered*)
		);
	...
	McSAMELStallguardCfgUseReacEnum :
		...
		mcSAMELSCUR_NONE := 2 (*None - No reaction is triggered*)
		);
	...
	McSEX6AHHfType : STRUCT (*Hiperface RS485 interface configuration*)
		...
		ReferenceStationAddress : USINT; (*Address of the Sine/Cosine Reference station (255=broadcast)*)
